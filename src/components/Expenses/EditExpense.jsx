...
const EditExpense = ({ expense, userId, onSave, onCancel }) => {
    ...
    useEffect(() => {
        if (expense) {
            setFormData({
                feedCost: expense.feedCost.toString(),
                powderCost: expense.powderCost.toString(),
                labourCost: expense.labourCost.toString(),
                medicalCost: expense.medicalCost.toString(),
                machineryCost: expense.machineryCost.toString()
            });
        }
    }, [expense]);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await expenseAPI.updateExpense(expense.id, userId, expenseData);
                ...
                <div className="modal-body">
                    ...
                    <form onSubmit={handleSubmit} className="expense-form">
                        <div className="form-section">
                            <label className="section-label">UPDATE EXPENSE CATEGORIES</label>
