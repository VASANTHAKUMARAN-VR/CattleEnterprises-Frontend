...
const AddCowSalePost = ({ userEmail, onSuccess, onCancel }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log('AddCowSalePost: Submitting data...');
            const response = await cowSalePostAPI.addCowSalePost(submitData);
            console.log('AddCowSalePost: Success:', response);
            ...
            console.error('AddCowSalePost: Error:', error);
        ...
        <div className="cow-sale-post-form-container">
            <div className="cow-sale-post-form-box">
                <div className="cow-sale-post-form-header">
                    <h2><i className="fas fa-plus-circle"></i> Create Sale Post</h2>
                    <p>Share details about the cow you want to sell</p>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-group">
                        <label>
                            <i className="fas fa-image"></i> Cow Photo (Optional)
                        </label>
