...
const EditCowSalePost = ({ post, userEmail, onSuccess, onCancel }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const updateData = {
                ...
                imageUrl: formData.image ? undefined : previewImage // Keep existing if no new image
            };

            console.log('EditCowSalePost: Updating post:', post.id, updateData);
            const response = await cowSalePostAPI.updateCowSalePost(post.id, userId, updateData);
            console.log('EditCowSalePost: Success:', response);
            ...
            console.error('EditCowSalePost: Error:', error);
        ...
        <div className="cow-sale-post-form-container">
            <div className="cow-sale-post-form-box">
                <div className="cow-sale-post-form-header">
                    <h2><i className="fas fa-edit"></i> Edit Sale Post</h2>
                    <p>Update your cow sale post details</p>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-group">
                        <label>
                            <i className="fas fa-image"></i> Cow Photo
                        </label>
                    ...
                    <div className="form-group">
                        ...
                        <textarea
                            ...
                            onChange={handleInputChange}
                            placeholder="Describe the cow (breed, age, health condition, milk production, vaccination details, etc.)"
                            required
                            disabled={loading}
                            rows="5"
                        />
...
export default EditCowSalePost;